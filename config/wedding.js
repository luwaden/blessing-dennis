...
export const wedding = {
  bride: {
    firstName: 'Blessing',
    lastName: 'Okafor',
    bio: `Blessing is a Lagos-born architect whose creative eye shapes everything she touches — from the buildings she designs to the way she arranges wildflowers on a Sunday morning. She finds joy in long walks, the smell of old books, and conversations that stretch past midnight. Her laugh is the kind that fills a room.`,
    photo: 'https://res.cloudinary.com/YOUR_CLOUD/image/upload/w_600,h_800,c_fill/bride-portrait.jpg',
  },
  groom: {
    firstName: 'Dennis',
    lastName: 'Eze',
    bio: `Dennis grew up in Enugu with a deep love for music, football, and the unhurried pace of family Sunday lunches. Now a Lagos-based financial consultant, he has never lost that warmth. He is the man who remembers your order, notices when you are quiet, and always shows up — for everyone he loves.`,
